            ...
            <ScrollView>
                <View>
                    ...
                    <View style={{ height: 200, backgroundColor: 'white' }}>
                        <Image style={{ height: '100%', width: '100%', resizeMode: 'stretch' }} source={require('../assets/服务.png')} />
                    </View>
                    <View style={{ flexDirection: 'column', width: '100%', height: 320 }}>
                        <View style={{ backgroundColor: 'white', width: '100%', height: 100, flex: 1, flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                            <View>
                                <Image style={{ height: 50, width: 50, marginLeft: 10 }} source={require('../assets/服务2.png')} />
                            </View>
