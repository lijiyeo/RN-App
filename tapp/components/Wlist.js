                ...
                <View>
                    ...
                    <View style={{
                        ...
                        <View style={styles.box}>
                            <Image style={{ height: '100%', width: '100%', resizeMode: 'stretch' }} source={require('../assets/shj1.png')} />
                        </View>
                        <View style={styles.box}>
                            <Image style={{ height: '100%', width: '100%', resizeMode: 'stretch' }} source={require('../assets/shj2.png')} />
                        </View>
                        <View style={styles.box}>
                            <Image style={{ height: '100%', width: '100%', resizeMode: 'stretch' }} source={require('../assets/shj1.png')} />
                        </View>
